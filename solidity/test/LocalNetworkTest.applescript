set binFolder to "~/go/src/github.com/MOACChain/MoacVnode/build/bin"
set moacFolder to "~/go/src/github.com/MOACChain/MoacVnode/cmd/moac"
set scsFolder to "~/go/src/github.com/MOACChain/MoacScs/scsserver"
set scsBuildFolder to "~/go/src/github.com/MOACChain/MoacScs/build"
set jsFolder to "~/go/src/github.com/MOACChain/MoacVnode/solidity/"
	...
	tell current window
		...
		if runTill � 4 then
			...
			tell current session of moac1aTab
				...
				write text "cd " & binFolder
				write text "cd moac"
				write text "./moac attach ipc:/Users/biajee/go/src/github.com/MOACChain/MoacVnode/build/bin/moac/data/moac.ipc"
				delay 1
		...
		if runTill � 6 then
			...
			tell current session of moac2aTab
				...
				write text "cd " & binFolder
				write text "cd moac2"
				write text "./moac attach ipc:/Users/biajee/go/src/github.com/MOACChain/MoacVnode/build/bin/moac2/data/moac.ipc"
				delay 1
		...
		if runTill � 10 then
			...
			tell current session of moac3aTab
				...
				write text "cd " & binFolder
				write text "cd moac3"
				write text "./moac attach ipc:/Users/biajee/go/src/github.com/MOACChain/MoacVnode/build/bin/moac3/data/moac.ipc --jspath " & jsFolder
				delay 1
				write text "admin.addPeer(\"enode://17ad78ad3b84091719f8b1464b02177587071b8eca482a926434fe5f736deaa4de4312851573c61d996be1386fa2c14807e79c72fb985394902c472ffe48a201@[::]:30301\")"
